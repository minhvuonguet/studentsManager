...
@section('content')
    ...
    <table class="table table-bordered table-sinhvien">
        ...
        {{--*/  $dem = 1 /*--}}
        @foreach($list_sinh_vien as $sinh_vien_new)

            <tr >
                <td>{{$dem}}</td>
                <td>{{$sinh_vien_new->mssv}}</td>
                <td >{{$sinh_vien_new->fullname}} </td>
                <td >{{$sinh_vien_new->class}} </td>

                <td >{{$sinh_vien_new->birthday}} </td>
                {{--<td >{{$sinh_vien_new->khen_thuong}} </td>--}}
                {{--<td >{{$sinh_vien_new->note}} </td>--}}
                {{--<td >{{$sinh_vien_new->chuc_vu}} </td>--}}
                {{--<td >{{$sinh_vien_new->email}} </td>--}}
                {{--<td> {{$sinh_vien_new->point}} </td>--}}
